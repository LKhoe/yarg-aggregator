...
export function PublicListView({
  ...
  const allSongsHaveDownloads =
    list.songs.length > 0 &&
    list.songs.every((song) => song.downloadUrls.length > 0);

  const downloadUrls = list.songs
              ...
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button
                    ...
                    title={
                      !allSongsHaveDownloads
                        ? t("lists.downloadAllNoLinks")
                        : undefined
                    }
                  >
