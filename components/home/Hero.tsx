...
export default function Hero({ totalSongs }: HeroProps) {
  ...
  return (
    <MagneticCard intensity={0}>
      <div
        className="relative overflow-hidden rounded-xl p-6 sm:p-10 border border-primary/20 ring-1 ring-inset dark:ring-white/5 ring-black/5"
        style={{
          background:
      ...
      >
          ...
          >
            ...
            {totalSongs > 0 && (
              <span
                ...
                style={{
                  animation: "fade-slide-up 0.5s ease-out 0.1s forwards",
                }}
              >
        ...
        <AudioWaveform className="mt-4 opacity-60" />
      </div>
    </MagneticCard>
  );
}
