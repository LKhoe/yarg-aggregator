      ...
      <div className="flex items-center">
        ...
        <div className="flex flex-col">
          <Button
            ...
            className="px-1.5 h-[18px] rounded-l-none rounded-br-none border-input border-l-0 border-b-[0.5px] focus-visible:relative"
            variant="outline"
            size="icon"
          ...
          <Button
            ...
            className="px-1.5 h-[18px] rounded-l-none rounded-tr-none border-input border-l-0 border-t-[0.5px] focus-visible:relative"
            variant="outline"
            size="icon"
